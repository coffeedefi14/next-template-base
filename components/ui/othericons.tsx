...
export function LoaderPinwheelIcon(props: IconProps) {
  return (
    <svg
      {...props}
...
export function RedditIcon(props: IconProps) {
  return (
    ...
    >
      <defs />
      <g
        style={{ stroke: "none", strokeWidth: 0, fill: "none", fillRule: "nonzero", opacity: 1 }}
      ...
      >
        <circle
          ...
          style={{ fill: "rgb(255,69,0)", fillRule: "nonzero", opacity: 1 }}
        />
        <path
...
export function AlignCenterHorizontalIcon(props: IconProps) {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
...
export function PeopleLikeYouIcon(props: IconProps) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <path d="M16 3.13a4 4 0 0 0 0 7.75" />
    </svg>
  );
}
...
export function ChevronOpen({ className, ...props }: IconProps) {
  return (
    <svg
      {...props}
      className={className}
...
export function MilestonesIcon(props: IconProps) {
