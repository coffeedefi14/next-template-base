            ...
            <div className="sm:w-1/2">
              <div className="py-8 sm:py-10 pl-8 sm:pl-21 pr-8 sm:pr-10">
                <form>
                  ...
                  <div className="mb-4 relative">
                    <span className="absolute top-1/2 -translate-y-1/2 left-4">
                      <svg width="22" height="22" viewBox="0 0 16 12" fill="rgb(var(--muted)/0.8)" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <Checkbox/>
                    <Link href="/#" className="font-medium text-[10px] text-muted-foreground">Forgot Password?</Link>
                  </div>
                  <div className="pt-0">
                  <Button
                    variant="outline"
                  ...
                  >
                    ...
                    <p className="text-center text-xs text-foreground mt-4">
                      ...
                      <Link href="/signup" className="text-xs text-muted-foreground"> Sign-Up for Free</Link>
                    </p>
                  </div>
                </form>
              </div>
